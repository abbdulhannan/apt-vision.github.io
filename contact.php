...
<input type="text" class="form-control bg-transparent" name="name" id="name" placeholder="Your Name">
                <label for="name">Enter Username</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating">
<input type="email" class="form-control bg-transparent" required id="email" name="mail" placeholder="Your Email">
            <label for="email">Your Email</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
<input type="text" class="form-control bg-transparent" id="subject" required name="sub" placeholder="Subject">
                <label for="subject">Subject</label>
                                    </div>
                                </div>
                                <div class="col-12">
                                    <div class="form-floating">
<textarea class="form-control bg-transparent" placeholder="Leave a message here" required name="msg" id="message" style="height: 100px"></textarea>
                        <label for="message">Message</label>
                                    </div>
                                </div>
                                <div class="col-12">
 <button class="btn btn-outline-primary w-100 py-3" name="ins_btn" type="submit">Send Message</button>
                                </div>
                            </div>
                        </form>
                    </div>
        ...
        if(isset($_POST['ins_btn'])){
            ...
            $ins = "INSERT INTO contact_f VALUES('','".$name."','".$mail."','".$sub."','".$msg."')";
            $res = mysqli_query($con,$ins);
            if($res){
                echo "<script>confirm('Thanks For Contacting!')</script>";
            }
            else{
